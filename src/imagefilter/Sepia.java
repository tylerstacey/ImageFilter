...
/**
 * Sepia.java converts rgb to sepia.
 * 
...
public class Sepia {
    ...
    /**
     * Sepia accepts the path to the file as an argument and assigns it to the
    ...
    public void convert() throws IOException {
        ...
        resultName = getBaseName(filename) + "-sepia." + suffix;
