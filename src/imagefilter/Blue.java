...
/**
 * Blue.java converts rgb to blue scale
 * 
...
public class Blue {
    ...
    /**
     * Blue accepts the path to the file as an argument and assigns it to the
    ...
    /**
     * Converts the image pixel by pixel and outputs a new file with the "-blue"
    ...
    public void convert() throws IOException {
        ...
        resultName = getBaseName(filename) + "-blue." + suffix;
