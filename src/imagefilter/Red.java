...
/**
 * Red.java converts rgb to red scale
 * 
...
public class Red {
    ...
    /**
     * Red accepts the path to the file as an argument and assigns it to the
    ...
    /**
     * Converts the image pixel by pixel and outputs a new file with the "-red"
    ...
    public void convert() throws IOException {
        ...
        resultName = getBaseName(filename) + "-red." + suffix;
